...
{
    public class GameObjectViewPool : IViewPool<GameObject>
    {
        ...
        public GameObjectViewPool(Func<GameObject, GameObject> factory, Action<GameObject> onRent, Action<GameObject> onReturn, GameObject prefab, int allocationSize = 8)
        {
            _factory = factory;
            _onRent = onRent;
            _onReturn = onReturn;
